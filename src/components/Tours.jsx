...
const Tours = () => {
  return (
    <div className="border-b border-neutral-900 pb-4">
        ...
        className="my-20 text-center text-4xl">Propozycje zwiedzania</motion.h1>
        <div>{TOURS.map((tours, index) => (
            <div key={index} className="mb-8 flex flex-wrap lg:justify-center">
                ...
                className="w-full max-w-xl lg:w-3/4">
                    ...
                    <p className="mb-4 text-neutral-400 font-light tracking-tighter">{tours.description}</p>
